...
export const VOCAB_ITEMS: VocabSourceItem[] = [
  ...
  { slug: 'goodbye', category: 'greetings', level: 1, cantonese: '再見', jyutping: 'zoi3 gin3', englishGloss: 'goodbye', description: 'a cartoon child walking away down a path, looking back over their shoulder with a big smile and waving goodbye' },
